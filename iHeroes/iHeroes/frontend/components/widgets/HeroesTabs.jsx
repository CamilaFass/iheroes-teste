  ...
  render() {
    return (
      <div className="heroes-tab-container">
        <div
          className="heroes-tab"
          onClick={(event) => this.changeScreen(event, false)}
          data-active={"true"}
        >
          Cadastro dos Heróis
        </div>
        <div
          className="heroes-tab"
          onClick={(event) => this.changeScreen(event, true)}
          data-active={"false"}
        >
          Registro de Atividade dos Heróis
        </div>
      </div>
    );
  }
...
const mapDispatchToProps = (dispatch) =>
  bindActionCreators({ showHeroLogs }, dispatch);
