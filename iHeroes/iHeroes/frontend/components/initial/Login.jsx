      ...
      <div className="container-login">
        <div className="loginbox">
          ...
          <div className="loginbox-inputbox">
            <div id="login-form">
              <If show={this.props.auth.registerForm}>
                <input
                  type="string"
              ...
              <If show={this.props.auth.registerForm}>
                <input
                  ...
                  className="input"
                  onClick={() => {
                    this.submit(URL.register);
                  }}
                />
              </If>
            </div>
            <If show={!this.props.auth.registerForm}>
              <a href="#" onClick={this.props.showRegisterForm}>
                Registrar
              </a>{" "}
            </If>
            <If show={this.props.auth.registerForm}>
              <a href="#" onClick={this.props.showLoginForm}>
                Fazer Login
              </a>{" "}
            </If>
          </div>
...
const mapDispatchToProps = (dispatch) =>
  bindActionCreators(
    { getToken, showLoginForm, showRegisterForm, authenticate },
    dispatch
  );
