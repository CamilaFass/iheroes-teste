...
import {
  getData,
  requestHeroesData,
  requestOccurrencesData,
  requestHeroesLogData,
...
class Manager extends Component {
  ...
  async loadStates() {
    try {
      ...
      if (this.props.auth.authenticated) {
        ...
        await getData(
          this.requestOccurrencesData,
          this.props.getOccurrencesData
        );
  ...
  render() {
    ...
    return <div className="container-fluid">{authenticated}</div>;
  }
}
